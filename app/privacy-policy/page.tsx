  ...
  return (
    <>
      <Head>
        ...
        />
        <link rel="preload" href={privacyHero.src} as="image" />
      ...
      <main className="px-4 py-12 bg-white text-black">
        <div className="w-full max-w-4xl mx-auto flex flex-col gap-6 bg-eggshell text-gray-900 p-6 border-2 border-tealCustom rounded-lg">
          <h1 className="text-3xl font-bold text-lightMustard">
            Privacy Policy AlleyWay
          </h1>

          <p>
            At AlleyWay, we value and respect your privacy. This Privacy Policy
            outlines how we handle any information collected through our
            website, which is designed solely for informational purposes.
          </p>
          ...
          <p>
            ...
            browsing our website. Our website is informational only and does not
            require users to create accounts, log in, or provide any personal
            details to access its content.
          </p>
          ...
          <p>
            ...
            event-related questions. Any information submitted through this
            form, including your name and email address, will solely be used to
            respond to your query. We do not store this information for any
            future use, and it is not shared with third parties.
          </p>

          <h2 className="text-2xl font-semibold">3. No Data Storage</h2>
          <p>
            AlleyWay does not store, retain, or collect any personal data from
            visitors. Once your inquiry has been addressed, all corresponding
            email data is securely managed and not kept for any marketing or
            database purposes.
          </p>
          ...
          <p>
            ...
            AlleyWay is not responsible for the privacy practices or content of
          ...
          <p>
            AlleyWay does not use cookies or other tracking technologies to
            monitor or collect visitor data.
          </p>
