  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Explore the projects we've successfully completed at Alleyway. From corporate events to private celebrations, discover our expertise."
        />
        <link rel="preload" href={projectsHero.src} as="image" />
        <meta property="og:title" content="Our Projects - Alleyway" />
        <meta
          property="og:description"
          content="Discover the diverse range of projects we have successfully completed, showcasing our dedication and expertise in event management."
        />
        <meta
          property="og:image"
          content="https://alleywaydxb.com/images/projects-page/projects-hero.webp"
        />
        <meta property="og:url" content="https://alleywaydxb.com/projects" />
        <meta property="og:type" content="website" />
        <meta
          name="keywords"
          content="Projects, Event Management, Alleyway, Corporate Events, Dubai, Private Celebrations"
        />
      </Head>
