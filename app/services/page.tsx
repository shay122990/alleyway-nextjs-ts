...
// import ProjectsCarousel from "./components/projects-carousel/Private-Events-Carousel"; 
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Comprehensive event management services in Dubai"
        />
      </Head>
      <Hero
        width={1920}
      ...
      <main className={styles.main}>
        <div className={styles.serviceSection} id="exhibitions&tradeshows">
          ...
          <ExhibitionSection
            exhibitionData={servicesPageData.exhibitions?.services || []}
          />
        </div>
        <div className={styles.serviceSection} id="private-events">
          <h2>{servicesPageData.privateEvents.title}</h2>
          {/* <ProjectsCarousel projects={servicesPageData.privateEvents.images} /> */}
        </div>
