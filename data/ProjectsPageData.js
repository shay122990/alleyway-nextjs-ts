...
export const projectSectionsData = [
  {
    sectionTitle: "SUCCESSFULLY DELIVERED",
    backgroundColor: "bg-black",
    sectionTitleColor: "text-tealCustom",
    h2Color: "text-lightMustard",
    pColor: "text-tealCustom",
    projects: [
      { h2: "DELOITTE", p: "AI Conference & Exhibition - UAE" },
      { h2: "SNAPCHAT", p: "Swipe Up Conference - UAE" },
      { h2: "GITEX", p: "Investor Lounge & Programme - UAE" },
      { h2: "MONSHA'AT", p: "E-commerce Forum - KSA" },
      { h2: "AMADEUS", p: "Altitude25 - Greece" },
      {
        h2: "#NOFILTERDXB MOTOR SHOW",
        p: "Oakley Skate Park Activation - UAE",
      },
    ],
    images: [
  ...
  {
    sectionTitle: "SUCCESSFULLY DELIVERED",
    backgroundColor: "bg-grayCustom",
    sectionTitleColor: "text-mustard",
    h2Color: "text-tealCustom",
    pColor: "text-lightMustard",
    projects: [
      { h2: "SPACE X - STARLINK", p: "Cocktail Reception - UAE" },
      { h2: "SANTA LUCIA SEGUROS", p: "#Despegamos Annual Event - Spain" },
      { h2: "HOTMART", p: "Hotmart Talks Retreat - Greece" },
      { h2: "PHONAK", p: "Sonova Launch Media Event - USA" },
  ...
  {
    sectionTitle: "SUCCESSFULLY DELIVERED",
    backgroundColor: "bg-lightMustard",
    sectionTitleColor: "text-white",
    h2Color: "text-white",
    pColor: "text-grayCustom",
    projects: [
      { h2: "GITEX AFRICA", p: "Inaugural Edition - Morocco" },
      { h2: "AZIZI", p: "Private Event - Germany" },
      { h2: "LEXUS", p: "Omotenashi Training - UAE" },
